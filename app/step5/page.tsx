...
export default function CoursivQuizStep5() {
  ...
  const handleSelection = (answer: string) => {
    ...
    router.push(`/step6?overwhelmed=${encodeURIComponent(answer)}`)
  }
      ...
      <header className="sticky top-0 bg-white z-10">
        <div className="flex items-center justify-between p-4 max-w-7xl mx-auto">
          ...
          <Image
            ...
            height={30}
          />
          <div className="text-gray-600 font-semibold text-sm">3/20</div>
        </div>
        {/* Barra de Progresso */}
        <div className="w-full bg-gray-200 h-1">
          <div
            className="bg-[#4F46E5] h-1"
            style={{ width: "15%" }} // 3 de 20 é 15%
          ></div>
        </div>
      </header>
      ...
      <main className="flex flex-col items-center justify-center py-12 px-4">
        <div className="w-full max-w-md text-center">
          <h1 className="text-3xl font-bold text-black mb-10">
            Do you feel overwhelmed with AI?
          </h1>
